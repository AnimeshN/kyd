...
urlpatterns = [
    ...
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/f5_dt_overview$', F5DtOverview.as_view(), name='f5'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/f6_oi_map$', F6OiMap.as_view(), name='f6'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/f7_iycf_map$', F7IycfMap.as_view(), name='f7'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/f8_pw_map$', F8PwMap.as_view(), name='f8'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/ft_lc_block$', FtLcBlock.as_view(), name='ftlcblk'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/ft_lc_project$', FtLcProject.as_view(), name='ftlcprjt'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/ft_lc_beat$', FtLcBeats.as_view(), name='ftlcbt'),
    url(r'^(?P<dist_name>[-\w]+)/(?P<fy>[-\w\ ]+)/kyd_dashboard/ft_radar1$', FtRdr1.as_view(), name='ftrdr1'),
    ...
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature3$', MahaFeatureThree.as_view(), name='maha-feat3'),
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature4$', MahaFeatureFour.as_view(), name='maha-feat4'), #radar1
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature5$', MahaFeatureFive.as_view(), name='maha-feat5'), #radar2
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature6$', MahaFeatureSix.as_view(), name='maha-feat6'), 
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feat6so$',  MahaFeatureStOw.as_view(), name='maha-feat6so'), 
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature7$', MahaFeatureSeven.as_view(), name='maha-feat7'), 
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature8$', MahaFeatureEight.as_view(), name='maha-feat8'), 
    url(r'^(?P<fy>[-\w\ ]+)/maha_dashboard/maha_feature9$', MahaFeatureNine.as_view(), name='maha-feat9'), 
